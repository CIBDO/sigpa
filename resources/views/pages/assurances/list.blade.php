        ...
        <div class="content">
            <div class="page-header">
                ...
                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                        data-bs-target="#ajouterPrestataireModal">
                        ...
                        <table class="table datanew">
                            ...
                            @foreach($assurances as $assurance)
                                <tr>
                                    ...
                                    <td>{{ $assurance->date_fin }}
                                        @if(\App\helpers\MyNotifications::getDriversWithInsuranceExpiringSoon($assurance->id_assurance))
                                    ...
                                    <td>
                                        <a class="me-3"
                                           href="{{route('assurances.edit', ['assurance' => $assurance->id_assurance])}}">
                                            <img src="{{asset('assets/img/icons/edit.svg')}}" alt="img">
                                        </a>
                                        <a href="{{ route('assurances.destroy', ['assurance' => $assurance->id_assurance]) }}"
                                           class="" onclick="event.preventDefault(); if(confirm('Êtes-vous sûr de vouloir supprimer?'))
                                       document.getElementById('delete-marque-form-{{$assurance->id_assurance}}').submit();">
                                        ...
                                        <form id="delete-marque-form-{{$assurance->id_assurance}}"
                                              action="{{ route('assurances.destroy', ['assurance' => $assurance->id_assurance]) }}"
            ...
            <div class="modal fade" id="ajouterPrestataireModal" tabindex="-1"
                 aria-labelledby="ajouterPrestataireModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('assurances.store') }}" method="post" id="ajouterPrestataireForm">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="jours_restant" id="jours_restant"
                                           readonly>
                                </div>
